"""This code houses all five of the models that the polymer application runs"""
...
#initiate the Flask module for the webApp
app = Flask(__name__)
...
@app.route('/floryHugs.html',methods=['POST','GET'])
def floryHugs():
	return render_template("floryHugs.html")
...
def calculateEnergies(phi,na,nb,chi):
	"""Plots free energy"""
...
def setupGraph(na,nb,chi):
	...
	for current_phi in phi:
		h[i],s[i],g[i] = calculateEnergies(current_phi,na,nb,chi)
		i += 1
